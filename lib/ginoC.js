    ...
    return {
        ...
        grid : function(){
            ...
            var _id, _container, _url, _page, _limit, _order, _filter,
                _enableFilter = false, _enableSort = false, _fieldMapping, _count,
                _filterQuery, _fQRowSep, _fQFieldSep, _complete;
            ...
            return {
                ...
                request : function () {
                    ...
                    $.ajax({
                        ...
                        error : _error,
                        success : _success,
                        complete: $.isFunction(_complete) ? _complete : void(null),
                    });

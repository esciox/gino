                ...
                case 'SEMANTIC':
                    ...
                    if (ginoU.isSet(result.responseJSON)) {
                        ...
                        if(ginoU.isSet(result.responseJSON.status)) {
                            ...
                            if (result.responseJSON.status == 401) {
                                if (ginoU.isSet(result.responseJSON.location)) {
                                    location = result.responseJSON.location;
                                }
                            }

                            html +=      'Code ' + result.responseJSON.status;
                        }

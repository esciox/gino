    ...
    var ginoU = function(){
        ...
        return {
            ...
            toggleLoader : function( targetObj, action ) {
                ...
                var w=0, h=0, top=0, left=0, html='', offset={};
                // set action
                ...
                switch (action) {
                    ...
                    case 'show':
                        ...
                        html += '"';
                        html += '><div style="position: relative; top:50px; text-align: center;">...Loading...</div></div>';

                        // insert div in DOM model
                        $('body').append(html);

                        $('#ginoLoader').fadeIn(700);

                        break;

                    case 'hide':
                        // remove div from DOM model
                        $('#ginoLoader').fadeOut(700, '', function(){
                            $(this).remove();
                        });
